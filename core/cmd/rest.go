...
func Setup() {
	...
	panelRepository := repository.NewPanelRepository(db)
	...
	keyService := service.NewKeyService(userRepository, keyRepository, panelRepository)
	...
	keyServerHandler := handler.NewKeyServerHandler(keyService)
